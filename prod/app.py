...
TRANSLATIONS = {
    "es": {
        ...
        "about_utn": "La Universidad Tecnológica Nacional (UTN) forma profesionales y genera conocimiento orientado al desarrollo tecnológico, industrial y productivo. A través de la excelencia académica, la investigación aplicada y la vinculación con empresas e instituciones, impulsa la innovación, el intercambio científico y la formación integral de estudiantes y graduados. Su compromiso con la actualización permanente de sus recursos, laboratorios y programas académicos le permite responder a los desafíos actuales de la industria y contribuir al crecimiento sostenible de la región y del país.",
        "about_utn_btn": "Visitar sitio de la UTN FRM",
        "about_repo": "Repositorio del proyecto",
        "team_title": "Integrantes",
        "team_badge": "LinkedIn",
        "repo_label": "Abrir repo",
        "puntos_verdes_title": "Programa Puntos Verdes",
        "puntos_verdes_desc": "Puntos Verdes es un programa ambiental orientado a reducir el impacto generado por los residuos mediante la promoción de la separación en origen, la recuperación de materiales reciclables y la educación ambiental. A través de una red de centros de acopio distribuidos estratégicamente, facilita la recolección de residuos secos como vidrio, papel, cartón y plástico, fomentando hábitos responsables en la comunidad. El programa articula acciones de concientización y participación ciudadana junto a organismos públicos, organizaciones sociales y recuperadores urbanos, impulsando la economía circular y la reutilización de recursos. De esta manera, contribuye a disminuir la cantidad de residuos destinados a disposición final, promoviendo una gestión más sostenible y un entorno más saludable para la población.",
        "puntos_verdes_btn_1": "Puntos Verdes · Godoy Cruz",
        "puntos_verdes_btn_2": "Puntos Verdes y Ruleros · Ciudad de Mendoza",
    },
    "en": {
        "app_title": "RecycleNet",
        ...
        "about_utn": "Universidad Tecnológica Nacional (UTN) trains professionals and generates knowledge oriented toward technological, industrial and productive development. Through academic excellence, applied research and partnerships with companies and institutions, it drives innovation, scientific exchange and the well-rounded education of students and graduates. Its commitment to continuously updating its resources, laboratories and academic programs lets it respond to today's industry challenges and contribute to the sustainable growth of the region and the country.",
        "about_utn_btn": "Visit UTN FRM website",
        "about_repo": "Project repository",
        "team_title": "Team",
        "team_badge": "LinkedIn",
        "repo_label": "Open repo",
        "puntos_verdes_title": "Green Points Program",
        "puntos_verdes_desc": "Green Points is an environmental program aimed at reducing the impact generated by waste by promoting source separation, the recovery of recyclable materials and environmental education. Through a network of strategically distributed collection centers, it facilitates the collection of dry waste such as glass, paper, cardboard and plastic, encouraging responsible habits within the community. The program coordinates awareness and civic participation actions together with public agencies, social organizations and urban waste recovery workers, driving the circular economy and resource reuse. In this way, it helps reduce the amount of waste sent to final disposal, promoting more sustainable management and a healthier environment for the population.",
        "puntos_verdes_btn_1": "Green Points · Godoy Cruz",
        "puntos_verdes_btn_2": "Green Points and Ruleros · City of Mendoza",
    },
    "pt": {
        "app_title": "RecycleNet",
        ...
        "about_utn": "A Universidad Tecnológica Nacional (UTN) forma profissionais e gera conhecimento orientado ao desenvolvimento tecnológico, industrial e produtivo. Por meio da excelência acadêmica, da pesquisa aplicada e da articulação com empresas e instituições, impulsiona a inovação, o intercâmbio científico e a formação integral de estudantes e graduados. Seu compromisso com a atualização permanente de seus recursos, laboratórios e programas acadêmicos permite responder aos desafios atuais da indústria e contribuir para o crescimento sustentável da região e do país.",
        "about_utn_btn": "Visitar site da UTN FRM",
        "about_repo": "Repositório do projeto",
        "team_title": "Equipe",
        "team_badge": "LinkedIn",
        "repo_label": "Abrir repositório",
        "puntos_verdes_title": "Programa Pontos Verdes",
        "puntos_verdes_desc": "Pontos Verdes é um programa ambiental voltado a reduzir o impacto gerado pelos resíduos por meio da promoção da separação na origem, da recuperação de materiais recicláveis e da educação ambiental. Através de uma rede de centros de coleta distribuídos estrategicamente, facilita a coleta de resíduos secos como vidro, papel, papelão e plástico, incentivando hábitos responsáveis na comunidade. O programa articula ações de conscientização e participação cidadã junto a órgãos públicos, organizações sociais e recicladores urbanos, impulsionando a economia circular e a reutilização de recursos. Dessa forma, contribui para diminuir a quantidade de resíduos destinados à disposição final, promovendo uma gestão mais sustentável e um ambiente mais saudável para a população.",
        "puntos_verdes_btn_1": "Pontos Verdes · Godoy Cruz",
        "puntos_verdes_btn_2": "Pontos Verdes e Ruleros · Cidade de Mendoza",
    },
}

LANG_OPTIONS = ["es", "en", "pt"]

TEAM_PHOTOS_DIR = os.path.join(os.path.dirname(__file__), "assets", "team")
...
.rn-hero-grid {{ grid-template-columns: 1.45fr; margin-bottom: 0.95rem; }}
...
/* LinkedIn pill button: brand-colored, icon + label, clear hover state. */
.rn-linkedin-btn {{
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
.rn-linkedin-btn svg {{ flex-shrink: 0; }}
...
.rn-link-btn:hover {{
  background: {accent};
  color: #06241c;
  box-shadow: 0 10px 22px rgba(84,214,178,0.28);
  transform: translateY(-1px);
}}
...
.rn-repo-link:hover {{
  color: #06241c;
  box-shadow: 0 10px 22px rgba(84,214,178,0.32);
  transform: translateY(-1px);
}}
  ...
  with right:
    ...
    with st.popover("☰"):
      ...
      for label, page_key in pages:
                if st.button(label, key=f"mobile_nav_{page_key}", use_container_width=True):
                    go(page_key)
                    st.rerun()
...
def render_team_cards() -> None:
    ...
    team = [
        ("Antonella Aldao", "AA", "aldao.jpg", "https://www.linkedin.com/in/antonellaaldao/"),
        ("Ignacio Berridy", "IB", "berridy.jpg", "https://www.linkedin.com/in/ignacioberridy/"),
        ("Carlos Gitto", "CG", "gitto.jpg", "https://www.linkedin.com/in/carlosgitto/"),
        ("Diandra Malca", "DM", "malca.jpg", "https://www.linkedin.com/in/diandra-malca-8099791b3/"),
        ("Ignacio Ramos", "IR", "ramos.jpg", "https://www.linkedin.com/in/ignacio-ramos-developer/"),
    ]

    linkedin_icon = (
        "<svg width='16' height='16' viewBox='0 0 24 24' fill='currentColor' "
        "xmlns='http://www.w3.org/2000/svg'><path d='M20.45 20.45h-3.56v-5.57c0-1.33-.02-3.04-1.85-3.04"
        "-1.85 0-2.14 1.45-2.14 2.95v5.66H9.34V9h3.41v1.56h.05c.48-.9 1.64-1.85 3.38-1.85 3.6 0 4.27 2.37"
        "4.27 5.46v6.28zM5.34 7.43a2.07 2.07 0 1 1 0-4.14 2.07 2.07 0 0 1 0 4.14zM7.12 20.45H3.56V9h3.56"
        "v11.45z'/></svg>"
    )

    cols = st.columns(len(team), gap="small")
    for col, (name, initials, filename, url) in zip(cols, team):
        with col:
            photo_path = team_photo_path(filename)
            if photo_path:
                # Encode the photo as base64 so it can sit inside the
                # rounded avatar alongside the rest of the card markup.
                import base64

                with open(photo_path, "rb") as photo_file:
                    encoded = base64.b64encode(photo_file.read()).decode("utf-8")
                ext = os.path.splitext(photo_path)[1].lstrip(".").lower() or "jpeg"
                avatar_inner = f"<img src='data:image/{ext};base64,{encoded}' alt='{name}' />"
            else:
            ...
            st.markdown(
                ...
                <div class='rn-team-card'>
                  <div class='rn-avatar'>{avatar_inner}</div>
                  <h4>{name}</h4>
                  <a class='rn-linkedin-btn' href='{url}' target='_blank' rel='noopener noreferrer'>
                    {linkedin_icon}
                    <span>{t('team_badge')}</span>
                  </a>
                </div>
                """,
                unsafe_allow_html=True,
...
def team_photo_path(filename: str) -> str | None:
    """Return the path to a team member's photo if it exists on disk."""
    path = os.path.join(TEAM_PHOTOS_DIR, filename)
...
def render_recycling_page() -> None:
    ...
    st.markdown(
        ...
        <div class='rn-hero-panel'>
          <h3 class='rn-section-title'>🌱 {t('puntos_verdes_title')}</h3>
          <p>{t('puntos_verdes_desc')}</p>
          <div class='rn-link-row'>
            <a class='rn-link-btn' href='https://www.godoycruz.gob.ar/godoy-cruz-sustentable/puntos-verdes/' target='_blank' rel='noopener noreferrer'>{t('puntos_verdes_btn_1')} ↗</a>
            <a class='rn-link-btn' href='https://ciudaddemendoza.gob.ar/tramites/programa-de-puntos-verdes-y-ruleros/' target='_blank' rel='noopener noreferrer'>{t('puntos_verdes_btn_2')} ↗</a>
          </div>
        </div>
        """,
        unsafe_allow_html=True,
    ...
    st.markdown(
        ...
        <div class='rn-hero-grid'>
          <div class='rn-hero-panel'>
            ...
            <p>{t('about_utn')}</p>
            <a class='rn-link-btn' href='https://frm.utn.edu.ar/' target='_blank' rel='noopener noreferrer'>{t('about_utn_btn')} ↗</a>
          </div>
        </div>
        """,
        unsafe_allow_html=True,
